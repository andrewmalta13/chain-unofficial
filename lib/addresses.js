    ...
    opts.chain.getAddresses(addresses, function (err, resp){
      if (err){
        ...
        for (var i = 0; i < resp.length; i++){
          ...
          summary.balance = resp[i].total.balance;
          summary.comfirmedBalance = resp[i].confirmed.balance;
          summary.unconfirmedBalance = resp[i].total.balance - resp[i].total.balance;
